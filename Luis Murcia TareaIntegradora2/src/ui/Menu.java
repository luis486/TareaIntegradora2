...
public class Menu {
    ...
    public void showMenu() {
        System.out.println(
                "Bienvenidos a su aplicación mos confiable MSC, a continuacion, podra elegir una de las opciones en el siguiente menu");
    ...
    public String readPlaylist() {
        ...
        System.out.println(
                "Por favor ingrese el tipo de Playlist que desea agregar\n 1 Privada\n 2 Restringida\n 3 Publica");
        int type = sc.nextInt();
        return msg;
    }
